            ...
            <div>
                ...
                <table
                    ...
                    <tbody id="materiasTable">
                        <tr>
                            <td><input type="text" name="materias[]"
                                    class="w-full p-2 text-xs border border-gray-300 dark:border-gray-700 rounded-lg dark:bg-gray-800 dark:text-white"
                                    required></td>
                            <td><input type="text" name="grupos[]"
                                    class="w-full p-2 text-xs border border-gray-300 dark:border-gray-700 rounded-lg dark:bg-gray-800 dark:text-white"
                                    required></td>
                            <td><input type="text" name="siglas[]"
                                    class="w-full p-2 text-xs border border-gray-300 dark:border-gray-700 rounded-lg dark:bg-gray-800 dark:text-white"
                                    required></td>
